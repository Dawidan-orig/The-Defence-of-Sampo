...
public class Blade : MeleeTool
{
    ...
    //TODO : Сделать фиксированное расстояние, относительно которого и будут ставиться iterations.
    // Получится, что iterations будет определять "Плотность" предсказаний, давая возможности для алгоритмов оптимизиации
