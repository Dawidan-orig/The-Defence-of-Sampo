...
public class Movement : MonoBehaviour
{
    ...
    [Tooltip("Максимальная возможная скорость, которую может развить этот Rigidbody, и которую будет уменьшать до спринта")]
    public float maximumReachableSpeed = 25;
    [Tooltip("Скорость, после которой персонаж спотыкается и падает в Ragdoll")]
